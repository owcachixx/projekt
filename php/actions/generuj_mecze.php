...
if(isset($_POST['turniej_id'], $_POST['liczba_meczy_jednoczesnie'], $_POST['sedzia']) && is_array($_POST['sedzia'])){
    ...
    $sql="DELETE FROM MECZ WHERE turniej_id=".$turniej_id;
    ...
    foreach($mecze as $mecz){
        ...
        $sql_insert = "INSERT INTO mecz (druzyna_1, druzyna_2, sedzia, sedzia_asystent_1, sedzia_asystent_2, turniej_id) VALUES ($druzyna1, $druzyna2, $sedzia, $asystent1, $asystent2, $turniej_id)";
