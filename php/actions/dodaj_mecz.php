...
if(isset($_POST['druzyna_1']) && isset($_POST['druzyna_2']) && isset($_POST['turniej']) && isset($_POST['sedzia']) && isset($_POST['sedzia_asystent_1']) && isset($_POST['sedzia_asystent_2'])){
    ...
    $sql="INSERT INTO mecz (druzyna_1, druzyna_2, turniej, sedzia, sedzia_asystent_1, sedzia_asystent_2) VALUES ('$druzyna_1', '$druzyna_2', '$turniej', '$sedzia', '$sedzia_asystent_1', '$sedzia_asystent_2')";
