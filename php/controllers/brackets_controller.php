<?php
require_once __DIR__."/../models/drabina_model.php";
require_once __DIR__."/../models/mecz_model.php";
function bracket($runda=1,) {
    $liczba_druzyn=liczba_meczy();
    $liczba_druzyn=$liczba_druzyn*2;
        ...
        if(mysqli_num_rows($query)> 0){
            ...
            if($runda == 1){
                ...
                if(!$query_bye){
                    ...
                    while($row_bye=mysqli_fetch_assoc($query_bye)){
                        echo "<div class='matchup' 
                                data-id='$row_bye[id]'
                                data-score1='5'
                                data-score2='0'
                                data-team1='$row_bye[wynik_1]'
                                data-team2='$row_bye[wynik_2]'>
                            <div class='participants'>
                                <div class='participant'>
                        ...
                        if(!$query_next_round){
                            ...
                            if(mysqli_num_rows($query_next_round)> 0){
                                ...
                                <form method="post" action="../php/actions/generuj_runde.php" id='form_generuj_runde'>
                                    ...
                                    <input type="hidden" name="turniej_id" value="<?= $_SESSION['turniej_id']; ?>">
