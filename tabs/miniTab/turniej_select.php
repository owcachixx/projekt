...
<form method="post" action="../php/includes/sesja_turniej.php" id="turniej_select_form" style="display: none;">
...
<form method="post" action="php/actions/dodaj_turniej.php" id="dodaj_turniej_form" class="dodaj_turniej_form" style="display: none;">
